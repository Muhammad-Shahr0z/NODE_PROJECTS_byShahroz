...
if (curruncyConverter.convertAmount > 0) {
    ...
    switch (curruncyConverter.toCurruncy) {
        case "USD":
            console.log(chalk.green(`Your Converted Amount is ${roundedNumber} In USD`));
            break;
        case "EUR":
            console.log(chalk.green(`Your Converted Amount is ${roundedNumber} In Euro`));
            break;
        case "INR":
            console.log(chalk.green(`Your Converted Amount is ${roundedNumber} In Indian Rupees`));
            break;
        case "PKR":
            console.log(chalk.green(`Your Converted Amount is ${roundedNumber} In Pakistani Rupees`));
            break;
    }
}
else {
