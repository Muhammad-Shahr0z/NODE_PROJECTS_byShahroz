...
const answer: any = await inquirer.prompt([
  { message: "Enter Your First Number", type: "number", name: "firstNumber" }, //Name is a Variable that Store Number
  { message: "Enter Your Second Number", type: "number", name: "secondNumber" }, //Name is a Variable that Store Number
  {
