...
if (answer.pinCode === defaultPinCode) {
  ...
  if (Transactions.select === "Withdraw") {
    ...
    if (
      transactionAmount.withdrawAmount <= curruntBalance &&
      ...
      console.log(
        chalk.redBright.bold.italic.underline("Insufficient Balance")
      );
    }
  }
  ...
  if (Transactions.select === "Change_Pin") {
    ...
    if (changePin.newPin >= 1000 && changePin.newPin <= 9999) {
      ...
      console.log(
        chalk.redBright.bold.italic.underline(
          "Enter Your Valid 4 Digits Pin Code "
        )
      );
    }
  }
  ...
  console.log(
    chalk.redBright.bold.italic.underline("Invalid PinCode")
  );
